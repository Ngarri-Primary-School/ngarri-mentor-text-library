...
The immediate next action is to complete and validate the AI review drafts for the five selected books and the missing text-type and genre classifications for the five approved pilot books. Keep all new material `ai_suggested` until Phill reviews it; do not expose it in teacher-facing pages or filters before approval. No paid generation or bulk enrichment is authorised by the transfer. Steve's invitation and school-account Codex connection remain pending. Supabase and hosting ownership require their own handover.
